...
struct Grayscale: View {
        ...
        ScrollView {
            VStack {
                ...
                VStack {
                    ...
                    HStack {
                        Text("Then we set the Saturation value to be 0 and convert back to RGB.\n")
                        Spacer();
                    }
                    ...
                    HStack {
                        Text("The calculated R3, G3, and B3 are the RGB values of the original pixel that has been transformed to grayscale.\n")
                        Spacer();
                    }
                    
                    HStack {
                        Text("Below, you can see an example image that has been put through the Grayscale Filter. By pressing \"Select Image\", you can use the filter on one of your own images. If you are trying to load a large file, it may take some time for the filter to finish processing the image.\n")
                        Spacer();
                    }
    ...
    func loadImage() {
        ...
        outputImage = Processor().applyFilter(inputImage: inputImage, type: "grayscale");
...
struct Grayscale_Previews: PreviewProvider {
