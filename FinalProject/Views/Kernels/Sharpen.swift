...
struct Sharpen: View {
        ...
        ScrollView {
            VStack {
                ...
                VStack {
                    ...
                    HStack {
                        Text("Below, you can see an example image that has been put through the Sharpen Kernel. By pressing \"Select Image\", you can use the filter on one of your own images. If you are trying to load a large file, it may take some time for the filter to finish processing the image.\n")
                        Spacer();
                    }
    ...
    func loadImage() {
        ...
        outputImage = Processor().applyFilter(inputImage: inputImage, type: "3x3_sharpen");
...
struct Sharpen_Previews: PreviewProvider {
